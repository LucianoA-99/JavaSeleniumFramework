...
public class RegisterCheckoutTest extends BaseTest{
	WebDriver driver;
	
	@Test(dataProvider="getData", groups = {"NoPreviousAccountCreationRequired"})
	public void RegisterCheckout(HashMap<String,String> input) throws IOException, InterruptedException {
		...
		checkout.verifyDetails(firstN, lastN, companyN, address, address2, countryN, stateN, cityN, zipcodeN, mobileN);
